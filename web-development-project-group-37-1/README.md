...
Documentation of Group 37 Project
In this project there will be a weather widget,currency widget and a random fact widget

lawson duong have also did change the design of the webpage 
Lawson Duong will be responsible on creating the weather widget

bhavesh will be responsible on creating the currency widget 

Tran nguyen dung nghi is to do the random fact widget 
for the webpage is gonna let user log in and post a blog post 